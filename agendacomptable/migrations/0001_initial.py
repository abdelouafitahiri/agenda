# Generated by Django 5.0.9 on 2025-01-11 18:12
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('nom_complet', models.CharField(blank=True, max_length=100, null=True, verbose_name='Nom Complet')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('lieu_naissance_representant', models.CharField(blank=True, max_length=255, null=True, verbose_name='Lieu de naissance du représentant légal')),
                ('nom_pere_representant', models.CharField(blank=True, max_length=255, null=True, verbose_name='Nom du père du représentant')),
                ('nom_mere_representant', models.CharField(blank=True, max_length=255, null=True, verbose_name='Nom de la mère du représentant')),
                ('loyer_mensuel_contrat', models.DecimalField(decimal_places=2, max_digits=10, verbose_name='Loyer mensuel (contrat)')),
                ('loyer_mensuel_plateforme', models.DecimalField(decimal_places=2, max_digits=10, verbose_name='Loyer mensuel (plateforme)')),
                ('date_debut', models.DateField(verbose_name='Date de début')),
                ('date_fin', models.DateField(verbose_name='Date de fin')),
                ('conditions', models.TextField(blank=True, null=True, verbose_name='Conditions du contrat')),
                ('date_contrat', models.DateField(verbose_name='Date du contrat')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('profession', models.CharField(blank=True, max_length=35, null=True, verbose_name='Profession')),
        ...
        migrations.AddField(
            model_name='customerfile',
            name='regime_tva',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='agendacomptable.regime'),
        ),
        migrations.CreateModel(
            name='Service',
            fields=[
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('service', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='agendacomptable.service', verbose_name='Service')),
            ],
        ),
        migrations.CreateModel(
            name='Societe',
